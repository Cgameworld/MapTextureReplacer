   ...
   // useDataUpdate(react, 'map_texture.current_vehicle_count', setCurrentCount)
    ...
    return <$Panel react={react} title="Map Texture Replacer">
        <div className="field_MBO">
            ...
            <button className="button_WWa button_SH8" onClick={() => engine.trigger('map_texture.open_image')}>Select Image</button>
        </div>
        <div className="field_MBO">
            <div className="label_DGc label_ZLb">Grass Normal</div>
            <button className="button_WWa button_SH8" onClick={() => engine.trigger('map_texture.remove_vehicles')}>Select Image</button>
        </div>
        <div className="field_MBO">
